      ...
      <div className="mx-auto p-4 pt-0">
        <div className="flex items-center justify-between pl-4 m-0">
          ...
          <a className="p-0 m-0 text-inherit no-underline" href="#">
            <Image
              src="/assets/image/logo-blue-dark.png"
              alt="Masco"
              width="109"
              height="24"
            />
          ...
          <ul className="nav_option flex flex-row pl-8">
            <li className="mx-8 list-none">
              <a
                href="#"
                className="text-slate-600 block font-bold font-sans text-lg"
              >
                Demo
              </a>
            </li>
          ...
          <div className=" flex mr-8">
            <button className="px-8 font-bold font-sans text-lg text-slate-700">
              Login
            </button>
            <button className="bg-blue-700 rounded-md min-w-40 py-3 font-semibold font-sans text-lg text-white">
              Sign up free
            </button>
          </div>
        </div>
